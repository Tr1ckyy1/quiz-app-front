<template>
  <main class="relative">
    <div class="flex flex-col items-center justify-center sm:items-start sm:justify-start">
      <div class="sm:px-24">
        <img class="hidden sm:block" src="../../assets/quizwiz-desktop.png" />
        <img class="sm:hidden" src="../../assets/MobileFrame.png" />
      </div>

      <img
        src="../../assets/main-picture-desktop.png"
        class="hidden sm:block absolute z-10 right-0 top-10"
      />

      <div class="-mt-32 w-full z-20 sm:mt-28 sm:z-0">
        <div class="bg-red-main w-full p-14">
          <h1 class="font-black text-white text-4xl flex flex-col gap-2 font-raleway">
            200+
            <RouterLink
              to="/quizzes"
        ...
        <div class="p-14 bg-blue-main w-full">
          <h1 class="font-black text-white text-4xl flex flex-col gap-2 font-raleway">
            250+
            <RouterLink
              to="/quizzes"
