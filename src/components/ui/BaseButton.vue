  ...
  computed: {
    customized() {
      ...
      if (this.mode === 'authButton')
        return 'block text-center bg-black w-full border-black border text-white py-4 rounded-xl font-bold sm:enabled:hover:bg-white sm:enabled:hover:text-black sm:duration-300 disabled:cursor-not-allowed disabled:opacity-20'
