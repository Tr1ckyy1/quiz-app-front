<template>
  ...
  >
    <div
      ...
      class="flex items-center z-[120] gap-6 w-[340px] fixed top-4 right-1/2 translate-x-1/2 sm:-translate-x-0 sm:right-12 border-b-[3px] font-raleway py-3 rounded-lg px-8 bg-gradient-to-r to-[#242C32] to-35% overflow-hidden"
      :class="design"
    >
